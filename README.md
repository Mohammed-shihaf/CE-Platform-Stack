# CE-Platform-Stack — branch CE-021
...
|---|---|---|
| Vite (not a real standalone Angular CLI production bundler in Angular 20 — esbuild used instead; see "About the 'Vite' requirement" below) | npm | Monolith |
