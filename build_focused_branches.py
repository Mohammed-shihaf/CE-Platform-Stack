...
BRANCHES = [
    ...
    ("CE-PYTS-002", "setuptools", "npm", "Microservices"),
    ("CE-PYTS-003", "poetry", "pnpm", "Monolith"),
    ("CE-PYTS-004", "poetry", "pnpm", "Microservices"),
    ("CE-PYTS-005", "hatch", "yarn (Berry)", "Monolith"),
    ("CE-PYTS-006", "hatch", "yarn (Berry)", "Microservices"),
    ("CE-PYTS-007", "flit", "bun", "Monolith"),
    ("CE-PYTS-008", "flit", "bun", "Microservices"),
    ("CE-PYTS-009", "uv", "npm (esbuild/vite)", "Monolith"),
    ("CE-PYTS-010", "uv", "npm (esbuild/vite)", "Microservices"),
]
...
def main():
    ...
    run_cmd('git commit -m "add TypeScript backend index.ts and tsconfig.json"', repo_dir)

    for branch_name, py_tool, ts_pkg, arch in BRANCHES:
        print(f"--> Updating & Pushing branch {branch_name} ({py_tool} / {ts_pkg} / {arch})...")
