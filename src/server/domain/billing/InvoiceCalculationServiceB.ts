export interface InvoiceSettlementParams {
  baseAmount: number;
  countryCode: string;
  isTaxExempt: boolean;
...
export class InvoiceCalculationServiceB {
  public calculateSettlement(params: InvoiceSettlementParams): InvoiceSettlementResult {
